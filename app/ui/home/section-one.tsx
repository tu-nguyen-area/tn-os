    ...
    <div className="md:flex justify-between md:py-8">
      <div className="text-black md:pb-12">
        <p className="text-2xl md:text-3xl">
          <span className="text-2xl md:text-3xl bg-gradient-to-r from-blue-500
            via-purple-500 to-rose-500 bg-clip-text font-bold text-transparent
            text-center"
          >
            TNOS 0.0.8
          </span> is now available for download
        </p>
        <p className="">Discover the latest and greatest features in our most recent interim release.</p>
        <p>Delivering the latest Linux 6.16 kernel, extended support for the most recent toolchains, and new experimental security features.</p>
        <div className="my-8">
          <Link href="/download">
