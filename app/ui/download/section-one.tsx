      ...
      <div className="py-8 md:flex justify-between">
        <div>
          ...
          <div className="my-6 grid md:flex gap-8">
            <Link target="_blank" href="https://drive.google.com/file/d/1R6cyWK52O_7CNr49s0IfKFBnNDcXYhLS/view">
            ...
            <Link target="_blank" href="https://drive.google.com/file/d/10Ksirr1Ns1wtUcMzfgBVnHR9WQyD0OqA/view">
              <button className="bg-black rounded-lg text-white p-2 w-full
                md:w-36 h-10 hover:bg-gradient-to-r hover:from-blue-500
                hover:via-purple-500 hover:to-rose-500"
              >
