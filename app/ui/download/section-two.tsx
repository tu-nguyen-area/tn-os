...
export default function SectionTwo() {
  ...
  <>
    ...
    <div>
      ...
      <div className="mt-6">
        <Link target="_blank" href="https://drive.google.com/file/d/1OlYyXU3ZU9h8v3N9uzTVGpDQdOF5PWOY/view">
          <button className="bg-black rounded-lg text-white p-2 w-full md:w-36 h-10 hover:bg-gradient-to-r hover:from-blue-500 hover:via-purple-500 hover:to-rose-500">
            TNOS Server
          </button>
        </Link>
      </div>
